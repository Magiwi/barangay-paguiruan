...
@php
    ...
    $projectType = trim((string) data_get($extra, 'project_type', '')) ?: '________________________';
    $projectLocation = trim((string) data_get($extra, 'project_location', '')) ?: '________________________';
    $purpose = trim((string) $permit->purpose) !== '' ? $permit->purpose : 'building permit processing';
...
<div class="frame">
    ...
    <div class="col-right">
        ...
        <div class="doc-title">BUILDING<br>PERMIT</div>
        ...
        <p class="paragraph">
            ...
            <span class="strong">{{ $applicantAddress }}</span>, requested a building permit.
        </p>

        <div class="info-box">
            <p class="info-row"><span class="strong">Project Type:</span> {{ $projectType }}</p>
            <p class="info-row"><span class="strong">Project Location:</span> {{ $projectLocation }}</p>
