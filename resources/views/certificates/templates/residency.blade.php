...
<div class="frame">
    ...
    <div class="col-right">
        ...
        <p class="paragraph">
            ...
            <span class="strong">{{ $residentAddress }}</span>, {{ \App\Models\SiteSetting::getValue('doc_jurisdiction_short') }}.
        </p>

        <p class="paragraph">
            This is to certify further, that the above-named person has been residing in
            <span class="strong">{{ $residentPurok }}</span>, {{ \App\Models\SiteSetting::getValue('doc_jurisdiction_medium') }}
