...
@php
    ...
    $residencyYears = $certificate->residency_years_text ?: '__________';
    ...
    $purpose = trim((string) $certificate->purpose) !== '' ? $certificate->purpose : 'whatever legal purposes it may serve';
@endphp
...
<div class="frame">
    ...
    <div class="col-right">
        <div class="doc-title">CERTIFICATE OF<br>RESIDENCY</div>
        <div class="section-label">TO WHOM IT MAY CONCERN:</div>

        <p class="paragraph">
            This is to <span class="strong">CERTIFY</span> that, <span class="strong">{{ $residentName }}</span>, of legal age, Filipino, is a bonafide resident of
            <span class="strong">{{ $residentAddress }}</span>, Barangay Paguiruan, Floridablanca, Pampanga.
        </p>

        <p class="paragraph">
            This is to certify further, that the above-named person has been residing in
            <span class="strong">{{ $residentPurok }}</span>, Paguiruan, Floridablanca, Pampanga
            <span class="strong">{{ $residencyYears }}</span>.
        </p>
        ...
        <p class="paragraph issued-block">
            Issued and given this <span class="strong">{{ $day }}</span> day of <span class="strong">{{ $month }}</span> <span class="strong">{{ $year }}</span>,
            at Barangay Paguiruan, Floridablanca, Pampanga.
        </p>
