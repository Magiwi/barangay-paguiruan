...
@php
    ...
    $purpose = trim((string) $certificate->purpose) !== '' ? $certificate->purpose : 'lawful purposes';
...
<div class="frame">
    ...
    <div class="col-right">
        <div class="meta">
            Certificate No.: <span class="strong">{{ str_pad((string) $certificate->id, 5, '0', STR_PAD_LEFT) }}</span><br>
            Date Issued: <span class="strong">{{ $month }} {{ $day }}, {{ $year }}</span>
        </div>

        <div class="doc-title">BARANGAY<br>CERTIFICATE</div>
        ...
        <p class="paragraph">
            ...
            of legal age, Filipino, and a bona fide resident of <span class="strong">{{ $residentAddress }}</span>,
            <span class="strong">{{ $residentPurok }}</span>, Barangay Paguiruan, Floridablanca, Pampanga.
        </p>
        ...
        <p class="paragraph">
            This certification is issued for whatever legal intent and purpose it may serve.
        </p>
