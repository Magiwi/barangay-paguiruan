...
<div class="frame">
    ...
    <div class="col-right">
        ...
        <p class="paragraph">
            ...
            is a bonafide resident of {{ $residentAddress }}, Barangay Paguiruan, Floridablanca, Pampanga.
        </p>

        <p class="paragraph">
            <span class="strong">This is to CERTIFY further</span>, that the above-named person belongs and is a part of the
            <span class="strong">INDIGENT FAMILIES</span> residing in Barangay Paguiruan, Floridablanca, Pampanga.
        </p>
