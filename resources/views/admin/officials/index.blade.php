...
<section class="px-4 py-8 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl space-y-8">
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <a href="{{ route('admin.officials.create') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                Legacy Appoint Form
            </a>
        </div>
                            ...
                            <div class="mt-3 flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-3">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-gray-500 truncate">
                                        {{ $official ? ($official->term_start->format('M d, Y') . ' - ' . optional($official->term_end)->format('M d, Y')) : 'Assign a staff/admin user to this slot.' }}
                                    </p>
                                </div>
                            </div>
        ...
        <div class="space-y-4">
            <div>
                <h2 class="text-lg font-semibold tracking-tight text-gray-800">Staff Officials</h2>
                <p class="text-sm text-gray-600">Operational staff assignments without term dates.</p>
            </div>
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm p-4">
                            ...
                            <div class="mt-3 flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-sm font-medium text-gray-800 truncate">{{ $official?->user?->full_name ?? 'NO RESIDENT ASSIGNED' }}</p>
                                    <p class="text-xs text-gray-500 truncate">
                                        {{ $official ? 'Active staff assignment' : 'Assign a staff/admin user to this slot.' }}
                                    </p>
                                </div>
                            </div>
