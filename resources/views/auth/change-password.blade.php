        ...
        <form method="POST" action="{{ url('/profile/password') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="password"
                       ...
                       class="block w-full rounded-lg border border-gray-300 px-4 py-2.5 text-gray-900 placeholder-gray-400 shadow-sm transition ui-form-focus @error('current_password') border-red-500 @enderror">
